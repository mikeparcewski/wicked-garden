...
```bash
/wicked-testing:execution scenario-calc.md --phase write
```
...
```bash
/wicked-testing:execution scenario-calc.md --phase execute --plan <test-plan-from-step-1>
```
...
```bash
/wicked-testing:execution scenario-calc.md --phase review --plan <test-plan> --evidence <evidence-report>
```
...
```bash
/wicked-testing:execution scenario-calc.md
```
