...
```bash
wicked-garden-qe execute scenario-calc.md --phase write
```
...
```bash
wicked-garden-qe execute scenario-calc.md --phase execute --plan <test-plan-from-step-1>
```
...
```bash
wicked-garden-qe execute scenario-calc.md --phase review --plan <test-plan> --evidence <evidence-report>
```
...
```bash
wicked-garden-qe execute scenario-calc.md
```
