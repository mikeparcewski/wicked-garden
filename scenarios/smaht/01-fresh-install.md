...
PLUGIN_DIR=$(cat "${TMPDIR:-/tmp}/wicked-scenario-plugin-dir")
MISSING=0
for SKILL in runtime-exec wickedizer mem integration-discovery; do
...
- [ ] Root-level skills discoverable via `/wicked-garden:help`: mem, integration-discovery, runtime-exec, wickedizer
