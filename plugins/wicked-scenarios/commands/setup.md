...
```
/wicked-scenarios:setup [--category api|browser|perf|infra|security|a11y]
```
...
{If all installed: "All tools installed. Run `/wicked-scenarios:list` to see available scenarios."}
