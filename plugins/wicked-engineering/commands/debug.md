...
```python
Task(
    subagent_type="wicked-engineering:debugger",
...
```
User: /wicked-engineering:debug TypeError: Cannot read property 'id' of undefined in UserService
