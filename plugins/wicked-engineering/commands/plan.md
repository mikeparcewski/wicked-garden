...
If approved, the plan can be executed using `/wicked-crew:execute` or manual implementation.

## Example

```
User: /wicked-engineering:plan Add rate limiting to the API endpoints
