...
| Command | Purpose |
|---------|---------|
| `/wicked-engineering:sync` | Check all documentation freshness |
| `/wicked-engineering:sync [path]` | Check specific path |
| `/wicked-engineering:sync --fix` | Auto-update where possible |

## Quick Start

```bash
# Check all documentation
/wicked-engineering:sync

# Check specific directory
/wicked-engineering:sync src/api

# Auto-fix simple issues
/wicked-engineering:sync --fix
```
