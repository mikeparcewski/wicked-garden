...
/wicked-delivery:design "Blue CTA increases clicks by 10%"

# Design with context file
/wicked-delivery:design feature-spec.md

# Discover available tools
/wicked-delivery:design --discover
```
...
- `/wicked-delivery:analyze` - Analyze experiment results
- `/wicked-delivery:rollout` - Plan feature rollout
