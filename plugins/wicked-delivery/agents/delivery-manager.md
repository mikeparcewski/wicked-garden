...
- **Reports**: Use /wicked-delivery:report for data-driven analysis
- **Risk**: Use wicked-delivery:risk-monitor for risk assessment
...
```
/wicked-mem:recall "sprint velocity"
/wicked-mem:recall "delivery patterns"
```
