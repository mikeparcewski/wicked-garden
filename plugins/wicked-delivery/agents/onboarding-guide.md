...
- **Delivery reports**: Use /wicked-delivery:report for team health overview
...
```
/wicked-delivery:report {data_file}
```
...
```
/wicked-mem:recall "team conventions"
/wicked-mem:recall "architecture decisions"
/wicked-mem:recall "onboarding"
```

**From codebase** (if wicked-search installed):
```
/wicked-search:docs README
/wicked-search:code "TODO|FIXME|HACK"
```
