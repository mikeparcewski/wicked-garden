...
- **Delivery reports**: Use /wicked-delivery:report for project context
- **Risk**: Use wicked-delivery:risk-monitor for cost-related risks
...
```
/wicked-delivery:report {project_data}
```
