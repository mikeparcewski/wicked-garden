...
- **Cost data**: Use wicked-delivery:finops-analyst for current cost analysis
- **Progress**: Use wicked-delivery:progress-tracker for timeline data
- **Memory**: Use wicked-mem for historical data points
- **Delivery**: Use /wicked-delivery:report for project metrics
...
```
/wicked-mem:store "Forecast {period}: cost ${baseline_total}, timeline {completion_date}, confidence {level}" --type discovery
```
