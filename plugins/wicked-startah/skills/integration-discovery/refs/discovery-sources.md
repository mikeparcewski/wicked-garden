...
Recommendation: Use wicked-platform:security-engineer as primary reviewer.
```
...
Relevant agents:
- `wicked-platform:security-engineer` - Security expertise
- `wicked-engineering:senior-engineer` - Code quality
