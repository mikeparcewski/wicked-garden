...
description: |
  ...
  end or on demand via /wicked-startah:report-issue.
...
```bash
/wicked-startah:report-issue bug          # File a bug report
/wicked-startah:report-issue ux-friction  # Report UX friction
/wicked-startah:report-issue unmet-outcome # Log an unmet outcome
/wicked-startah:report-issue --list-unfiled # View/file unfiled issues
```
...
# File them later
/wicked-startah:report-issue --list-unfiled
```
