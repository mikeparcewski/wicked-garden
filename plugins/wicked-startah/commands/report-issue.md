...
- If `gh` unavailable or no repo:
  ...
  - Tell user: "Issue saved to unfiled queue. Install and authenticate `gh` CLI, then run `/wicked-startah:report-issue --list-unfiled` to file."
