...
### Changed
- SessionStart hook now silent (removed setup nag message)
- No more "wicked-startah detected!" spam on every session

## [0.2.1] - 2025-01-27

### Changed
- SessionStart hook converted to Python for cross-platform compatibility
- Simplified marker-check logic

## [0.1.6] - 2026-01-25

### Added
- **wickedizer skill**: Complete writing/editing skill with 8 reference files
  - voice-profile.md - Team voice characteristics
  - de-ai-pass.md - AI tell detection and removal
  - artifact-types.md - Mode-specific guidance
  - failure-modes.md - Common anti-patterns
  - structure.md - Document architecture
  - complexity.md - KISS/YAGNI/DRY for writing
  - patterns.md - Reusable templates
  - review.md - Quality validation checklists

### Changed
- Genericized "Jira" references to "work items" (supports Linear, GitHub Issues, etc.)
- Renamed "Michael voice" to "Team voice" for broader applicability

## [0.1.5] - 2026-01-24

### Changed
- Bumped version for marketplace release
