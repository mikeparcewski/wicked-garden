...
| Command | Purpose |
|---------|---------|
| `/wicked-patch:plan` | Show what would be affected |
| `/wicked-patch:add-field` | Add field with propagation |
| `/wicked-patch:rename` | Rename across all usages |
| `/wicked-patch:remove` | Remove field everywhere |
| `/wicked-patch:apply` | Apply saved patches |
