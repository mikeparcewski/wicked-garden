...
/wicked-patch:remove "User.java::User" --field legacyStatus

# Preview removal
/wicked-patch:remove "Entity.java::Entity" --field oldField --verbose
```
...
/wicked-patch:remove SYMBOL --field foo -o patches.json
