...
/wicked-patch:add-field "User.java::User" --name email --type String --column USER_EMAIL

# Add required date field
/wicked-patch:add-field "Order.java::Order" --name createdAt --type datetime --required

# Save patches for review
/wicked-patch:add-field "Entity.java::Entity" --name foo --type String -o patches.json
```
