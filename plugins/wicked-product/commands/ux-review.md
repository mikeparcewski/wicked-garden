...
/wicked-product:ux-review src/components/Form --focus flows
/wicked-product:ux-review src/components/Form --focus ui
...
```
Task(
  subagent_type="wicked-product:a11y-expert",
...
```
Task(
  subagent_type="wicked-product:user-researcher",
...
### Recommendation
Run full review with `/wicked-product:ux-review {target} --focus all` for complete analysis.
```
...
```
User: /wicked-product:ux-review src/components/LoginForm.tsx --focus a11y
