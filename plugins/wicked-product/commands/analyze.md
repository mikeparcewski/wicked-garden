...
/wicked-product:analyze --theme "mobile experience"
/wicked-product:analyze --theme "performance"

# Filter by sentiment
/wicked-product:analyze --sentiment negative
/wicked-product:analyze --sentiment positive

# Trend analysis
/wicked-product:analyze --trend "last-quarter"
/wicked-product:analyze --trend "week-over-week"

# Segment analysis
/wicked-product:analyze --segment enterprise
/wicked-product:analyze --segment "new-users"
```
...
If no data found, prompt user to run `/wicked-product:listen` first.

### 2. Dispatch to Feedback Analyst

```
Task(
  subagent_type="wicked-product:feedback-analyst",
...
### Next Steps
Run `/wicked-product:synthesize` to generate actionable recommendations.
```

## Integration

- **wicked-product:listen**: Run first to aggregate feedback
- **wicked-product:synthesize**: Run after to generate recommendations
...
```
User: /wicked-product:analyze --theme "performance"
