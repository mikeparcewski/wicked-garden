...
/wicked-product:strategy feature-proposal.md

# Specific focus areas
/wicked-product:strategy feature.md --focus roi
/wicked-product:strategy feature.md --focus value
/wicked-product:strategy feature.md --focus market
/wicked-product:strategy feature.md --focus competitive

# Comprehensive analysis
/wicked-product:strategy initiative.md --focus all

# Quick assessment
/wicked-product:strategy idea.md --quick
```
...
```
Task(
  subagent_type="wicked-product:business-strategist",
...
```
Task(
  subagent_type="wicked-product:value-analyst",
...
```
Task(
  subagent_type="wicked-product:market-analyst",
...
```
Task(
  subagent_type="wicked-product:competitive-analyst",
...
Run `/wicked-product:strategy {target} --focus all` for complete analysis.
```

## Integration

- **wicked-product:elicit**: Feed requirements into strategy
...
```
User: /wicked-product:strategy mobile-app-proposal.md --focus roi
