...
| Command | Purpose |
|---------|---------|
| `/wicked-product:ux-review` | Run UX review (auto-detect focus) |
| `/wicked-product:ux-review --focus flows` | User flow analysis |
| `/wicked-product:ux-review --focus ui` | Visual design review |
| `/wicked-product:ux-review --focus a11y` | Accessibility audit |
| `/wicked-product:ux-review --focus research` | User research |
| `/wicked-product:ux-review --focus all` | Comprehensive review |
