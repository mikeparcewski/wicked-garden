...
description: |
  ...
  Use when you have aggregated feedback and need to extract patterns, themes,
  sentiment scores, or identify emerging trends.
---
...
- After running `/wicked-product:listen`
...
1. **Load Feedback Data**:
   ```bash
   # Count total items
   find ~/.something-wicked/voice/feedback/ -name "*.md" | wc -l

   # Load recent feedback
   find ~/.something-wicked/voice/feedback/ -name "*.md" -mtime -30
   ```
