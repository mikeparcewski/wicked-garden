...
1. Check wicked-qe:test-strategist availability for testability review
...
```
/wicked-mem:store "QE {gate} Gate: {decision} for {target}. {rationale}" --type decision --tags qe,gate,{gate}
```
