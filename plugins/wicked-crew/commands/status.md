...
If no projects exist, inform user and suggest `/wicked-crew:start`.
...
- If phase awaiting approval: suggest `/wicked-crew:approve {phase}`
- If phase in progress: suggest `/wicked-crew:execute`
