...
- Use `/wicked-agentic:context-engineering` for context optimization techniques
- Use `/wicked-agentic:agentic-patterns` for efficient orchestration patterns
- Use `/wicked-agentic:frameworks` for framework-specific optimizations
