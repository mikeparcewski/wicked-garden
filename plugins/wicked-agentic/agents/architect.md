...
- Use `/wicked-agentic:five-layer-architecture` for layer-specific guidance
- Use `/wicked-agentic:agentic-patterns` for pattern recognition
- Use `/wicked-agentic:frameworks` for framework-specific best practices
