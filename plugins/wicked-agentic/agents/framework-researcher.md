...
- Use `/wicked-agentic:frameworks` for framework-specific guidance
- Use `/wicked-agentic:agentic-patterns` for cross-framework patterns
- Use `/wicked-agentic:review-methodology` for systematic framework evaluation
