...
Instructions:
Load skills:
- wicked-agentic:five-layer-architecture
- wicked-agentic:agentic-patterns
...
#### Pattern Questions
```
Task: wicked-agentic:pattern-advisor
...
- **wicked-agentic:five-layer-architecture**: For architecture questions
- **wicked-agentic:agentic-patterns**: For pattern and performance questions
- **wicked-agentic:trust-and-safety**: For safety and security questions
- **wicked-agentic:frameworks**: For framework selection and comparison
- **wicked-agentic:maturity-model**: For readiness and capability assessment
...
- Run a review: `/wicked-agentic:review`
- Design an architecture: `/wicked-agentic:design`
- Compare frameworks: `/wicked-agentic:frameworks --compare`
- Run safety audit: `/wicked-agentic:audit`
...
```
User: /wicked-agentic:ask What's the difference between hierarchical and sequential patterns?
...
- Load skill `wicked-agentic:agentic-patterns` for 12 common patterns
- Run `/wicked-agentic:design` to see these patterns applied to your use case
```

### Safety Question

```
User: /wicked-agentic:ask How do I handle PII in agent systems?
...
- Load skill `wicked-agentic:trust-and-safety` for comprehensive safety guidance
- Run `/wicked-agentic:audit` to check your system for PII handling issues
```

### Framework Question

```
User: /wicked-agentic:ask Should I use LangChain or CrewAI?
...
- Run `/wicked-agentic:frameworks --compare langchain,crewai` for detailed comparison
- Load skill `wicked-agentic:frameworks` for framework selection guide
```

### Pattern Question

```
User: /wicked-agentic:ask What are anti-patterns in agentic systems?
...
Run `/wicked-agentic:review` to automatically detect these anti-patterns in your codebase.
...
- Load skill `wicked-agentic:agentic-patterns` for correct pattern implementations
- Run `/wicked-agentic:design` for anti-pattern-free architecture
```

### Performance Question

```
User: /wicked-agentic:ask How can I reduce latency in my agent system?
...
- Run `/wicked-agentic:review . --quick` for latency bottleneck analysis
- Load skill `wicked-agentic:agentic-patterns` for performance patterns
```
