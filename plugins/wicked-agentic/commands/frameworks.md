...
- Compare this with another framework? `/wicked-agentic:frameworks --compare`
- Design an architecture using this framework? `/wicked-agentic:design`
```
...
```
User: /wicked-agentic:frameworks --compare langchain,crewai,autogen
...
## Next Steps
Would you like me to design an architecture using one of these? Run `/wicked-agentic:design`
```

### Filter by Language and Use Case

```
User: /wicked-agentic:frameworks --language typescript --use-case customer-support
...
Would you like me to design a customer support architecture? `/wicked-agentic:design`
```

### Interactive Selection Wizard

```
User: /wicked-agentic:frameworks
...
```
/wicked-agentic:design "Research assistant that searches papers, extracts findings, and generates summaries"
```
```
