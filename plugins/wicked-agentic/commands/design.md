...
3. **Non-Functional Requirements**
   ...
   - Cost constraints?
   - Scale expectations (requests/day)?
...
```
User: /wicked-agentic:design "Build a customer support bot that can answer FAQs, create tickets, and escalate to humans when needed"
...
```
User: /wicked-agentic:design "Build a code review assistant" --output designs/code-review-agent.md
