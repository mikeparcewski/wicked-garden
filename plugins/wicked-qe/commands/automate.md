...
- **Scenarios output**: From `/wicked-qe:scenarios`
- **QE plan**: From `/wicked-qe:qe-plan`
...
```
User: /wicked-qe:automate --framework pytest
...
1. `/wicked-qe:scenarios` - Generate test scenarios
2. `/wicked-qe:qe-plan` - Create comprehensive test plan

Full QE workflow:
```
/wicked-qe:scenarios User login flow
/wicked-qe:automate --framework jest
