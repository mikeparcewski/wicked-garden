...
```
User: /wicked-qe:qe-review tests/ --focus quality
...
```
/wicked-qe:scenarios Feature X      # Generate scenarios
/wicked-qe:automate --framework jest # Generate test code
/wicked-qe:qe-review tests/          # Review quality
```
