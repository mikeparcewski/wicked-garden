...
|--------|---------------------|---------------------|
| Skill invocation | `Invoke Skill: wicked-mem:store, args: "..."` | Skill tool |
...
- **Action**: Invoke Skill: wicked-mem:store, args: "Use JWT for auth tokens" --type decision --tags "auth,security"
- **Evidence required**:
...
- **Action**: Invoke Skill: wicked-mem:recall, args: "authentication token strategy"
- **Depends on**: STEP-1
- **Evidence required**:
