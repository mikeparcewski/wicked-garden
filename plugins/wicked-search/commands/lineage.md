...
/wicked-search:lineage form_binding::person.firstName --direction downstream

# Find all UI fields that use a database column
/wicked-search:lineage column::USERS.EMAIL --direction upstream

# Generate Mermaid diagram of data flow
/wicked-search:lineage entity_field::User.email --format mermaid
```
