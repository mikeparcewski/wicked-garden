...
/wicked-search:impact column::USERS.EMAIL

# What uses this entity field?
/wicked-search:impact entity_field::User.email

# Impact analysis with JSON output
/wicked-search:impact USERS.FIRST_NAME --format json
```
...
- Use `/wicked-search:lineage --direction downstream` for the reverse (what does this symbol affect)
