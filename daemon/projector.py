...
_HANDLERS: dict[str, str] = {
    ...
    "wicked.garden.session.started":                      "_on_session_started",
    "wicked.garden.session.synthesized":                  "_on_session_completed",
    "wicked.garden.council.voted":                        "_on_session_completed",
    # Modernize / project lifecycle
    "wicked.garden.project.created":                      "_on_generic",
    "wicked.garden.project.completed":                    "_on_generic",
    "wicked.garden.archetype.created":                    "_on_generic",
    "wicked.garden.archetype.advanced":                   "_on_generic",
    ...
    "wicked.garden.gate.decided":                         "_on_generic",
    "wicked.garden.gate.blocked":                         "_on_generic",
    "wicked.garden.rework.triggered":                     "_on_generic",
    "wicked.garden.condition.marked_cleared":             "_on_generic",
    "wicked.garden.crew.inline_review_context_recorded":  "_on_generic",
    "wicked.garden.crew.yolo_revoked":                    "_on_generic",
    "wicked.garden.amendment.appended":                   "_on_generic",
    "wicked.garden.reeval.addendum_appended":             "_on_generic",
    "wicked.garden.convergence.transition_recorded":      "_on_generic",
    "wicked.garden.review.semantic_gap_recorded":         "_on_generic",
    "wicked.garden.hitl.decision_recorded":               "_on_generic",
    "wicked.garden.subagent.engaged":                     "_on_generic",
    "wicked.garden.dispatch.log_entry_appended":          "_on_generic",
    "wicked.garden.consensus.report_created":             "_on_generic",
    "wicked.garden.consensus.evidence_recorded":          "_on_generic",
    "wicked.garden.consensus.gate_completed":             "_on_generic",
    "wicked.garden.consensus.gate_pending":               "_on_generic",
}
