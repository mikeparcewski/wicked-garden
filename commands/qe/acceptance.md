...
Print exactly:
`[DEPRECATED] /wicked-garden:qe:acceptance is removed in v7.1 — use /wicked-testing:execution instead.`
...
- `/wicked-garden:qe:scenarios` — run or list acceptance scenarios (also deprecated; use `/wicked-testing:scenarios`)
