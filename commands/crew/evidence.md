...
### 5. Check wicked-brain:memory for Decisions

If wicked-brain available:
```
...
### Related Decisions (from wicked-brain:memory)
...
/wicked-garden:crew:evidence abc12345

# Evidence for task in specific project
/wicked-garden:crew:evidence abc12345 --project my-project
...
- Run `/wicked-garden:crew:gate --gate value` to generate gate evidence
