...
```bash
sh "${CLAUDE_PLUGIN_ROOT}/scripts/_python.sh" "${CLAUDE_PLUGIN_ROOT}/scripts/_run.py" scripts/agentic/analyze_agents.py --path "$TARGET_PATH" \
...
sh "${CLAUDE_PLUGIN_ROOT}/scripts/_python.sh" "${CLAUDE_PLUGIN_ROOT}/scripts/_run.py" scripts/agentic/pattern_scorer.py \
  --agents "$AGENTS_FILE" \
  --framework "$DETECTED_FRAMEWORK"
```
...
sh "${CLAUDE_PLUGIN_ROOT}/scripts/_python.sh" "${CLAUDE_PLUGIN_ROOT}/scripts/_run.py" scripts/agentic/issue_taxonomy.py \
...
### Basic Review
```
User: /wicked-garden:agentic:review ./src
...
### Quick Review
```
User: /wicked-garden:agentic:review . --quick
...
### Save to File
```
User: /wicked-garden:agentic:review . --output reports/agentic-review.md
