...
/wicked-garden:product:synthesize --priority critical

# Focus on specific feature area
/wicked-garden:product:synthesize --feature "mobile-app"
/wicked-garden:product:synthesize --feature "onboarding"

# Output format
/wicked-garden:product:synthesize --format brief
/wicked-garden:product:synthesize --format detailed
```
...
```
User: /wicked-garden:product:synthesize --priority high
