...
/wicked-garden:product:listen --capability surveys
/wicked-garden:product:listen --capability conversations
...
- **wicked-brain:memory**: Recall past customer insights
...
```
User: /wicked-garden:product:listen --days 7
