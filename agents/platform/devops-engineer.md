...
- **Memory**: Use wicked-brain:memory to recall pipeline patterns
...
- Use `/wicked-garden:platform:github-actions` for workflow generation
- Use `/wicked-garden:platform:gh-cli` for workflow debugging
- Use `/wicked-garden:platform:gitlab-ci` for GitLab pipelines
