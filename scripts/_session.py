...
class SessionState:
    ...
    # don't warrant individual dataclass fields. (The #544 wicked-testing
    # probe that used to populate it was removed in Phase 6c — the qe domain
    # ships in-catalog now.)
