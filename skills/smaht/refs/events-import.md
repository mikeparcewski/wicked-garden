# smaht events-import — DomainStore → Event Log Migration Rubric

Full rubric for the `events-import` sub-action of `skills/smaht/SKILL.md`
(formerly `commands/smaht/events-import.md`, retired in the skills-only consolidation).
Import existing DomainStore JSON records into the unified event log as historical events.

Args: `[--domain D] [--dry-run]`
