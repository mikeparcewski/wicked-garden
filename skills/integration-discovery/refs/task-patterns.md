...
| Store findings | Skill | wicked-garden-mem (store) |
...
4. Store critical findings via wicked-garden-mem (store)
...
| Store decisions | Skill | wicked-garden-mem (store) |
...
2. Store decisions via wicked-garden-mem (store)
...
| Post-mortem | Skill | wicked-garden-mem (store) |
...
4. Store learnings via wicked-garden-mem (store)
