...
```bash
/wicked-garden:delivery:report ~/Downloads/sprint-export.csv
```

### Comprehensive Report (All 6 Personas)
```bash
/wicked-garden:delivery:report ~/export.csv --all
```

### Focused Analysis
```bash
/wicked-garden:delivery:report ~/export.csv --personas qe-lead,delivery-lead
```

### Custom Output
```bash
/wicked-garden:delivery:report ~/export.csv --output ~/steering-committee/
```
