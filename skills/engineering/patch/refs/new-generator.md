# new-generator — author a new language generator
...
When this workflow is invoked, follow these steps to create a complete generator:
...
```
new-generator scala Slick
new-generator swift CoreData .swift
new-generator elixir Ecto .ex,.exs
```
