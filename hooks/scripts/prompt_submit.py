...
# _consume_phase_start_gate were removed. They referenced deleted scripts
# (current_chain.py, propose-process skill, phase_start_gate.py) that lived
# in the v6 universal-pipeline machinery. v11 archetypes handle re-eval
# inside their own playbooks.
...
def main():
    ...
    # v11: legacy facilitator re-eval + phase-start-gate consumers removed.
    # Those were tied to the v6 universal pipeline (propose-process + the
    # phase_start_gate.py script, both deleted in v11). v11 archetypes own
    # their own checkpoint cadence in their playbooks.
